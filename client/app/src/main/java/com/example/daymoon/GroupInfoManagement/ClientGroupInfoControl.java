...
public class ClientGroupInfoControl {
    ...
    public static void addGroup(GroupInformationHolder groupInformationHolder, Runnable success, Runnable failure){
        Map<String, String> params = new HashMap<>();
        params.put("groupName", groupInformationHolder.groupName);
        params.put("description", groupInformationHolder.description);
        params.put("leaderID", String.valueOf(groupInformationHolder.leaderID));
        new HttpRequestThread(SERVER_IP+"addgroup",params, new HttpRequest.DataCallback(){
            @Override
