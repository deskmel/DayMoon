...
import com.example.daymoon.Tool.TimerNotificationService;
import com.example.daymoon.UserInterface.NotificationActivity;
...
public class NotificationServiceUtil {
    ...
    public static void invokeTimerNotification(Context context,long time , String content , int id){
        ...
        try {
            alarmSender = PendingIntent.getService(context, id, startIntent, 0);
        } catch (Exception e) {

        }
        AlarmManager am = (AlarmManager) context.getSystemService(Activity.ALARM_SERVICE);
        Log.i("Alarm!!!!!!",String.valueOf(am == null));
